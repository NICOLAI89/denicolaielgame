...
| Frost tower replacement sprite | Project-authored for this repository | Repository license | No | `app/src/main/assets/towers/tower_frost.webp` |
...
These assets are bundled in Iteration 7B and Iteration 9. Kenney assets are Creative Commons CC0 and can be used commercially without required attribution. Optional credit is appreciated.
...
| Music Loops - `Space Cadet.ogg` | Kenney | https://kenney.itch.io/kenney-game-assets; downloaded from the Kenney Sound Pack mirror at https://gamesounds.xyz/?dir=Kenney%27s+Sound+Pack%2FMusic+Loops%2FLoops | Creative Commons CC0 | No, credit appreciated | `app/src/main/assets/audio/music/music_loop.ogg` |
...
| Music Jingles | Kenney | https://kenney.nl/assets/music-jingles | Creative Commons CC0 | Short stinger pack; not used for the Iteration 9 background loop because Music Loops provides the bundled music track. |
